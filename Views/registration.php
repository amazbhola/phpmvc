...
<div class="min-h-screen flex items-center justify-center bg-gray-800">
    <div class="bg-gray-700 opacity-80 shadow-md  shadow-gray-500 w-4/12 p-4">
        <h2 class="text-gray-50 text-2xl text-center tracking-wide mb-4">Registration</h2>
        <hr>
        <div class="p-4">
            <form action="<?php echo url('create') ?>" method="post" class="">
                <div class="pb-4">
                    <label class="text-gray-100" for="username">User Name</label><br>
                    <input class="w-full outline-none py-1 px-2 mt-4 text-gray-800" id="username" name="username" type="text" required><br>
                </div>
                <div class="pb-4">
